...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description, delay = 0 }) => {
  return (
    <div 
      className="bg-black bg-opacity-40 backdrop-blur-sm border border-jota-neon/20 rounded-xl p-6 hover:border-jota-neon/50 transition-all duration-300 group hover:scale-105 transform" 
...
const ServicesSection: React.FC = () => {
  return (
    <section id="services-section" className="py-20 px-6 relative overflow-hidden bg-gradient-to-b from-transparent to-black/40">
